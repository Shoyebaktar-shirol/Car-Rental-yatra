      ...
      <div class="row">
        <div class="col-sm-3 col-md-2">
          ...
          <div class="logo"> <a href="index.php">
              <img src="includes\newlogo.jpg" height="200" width="200" alt="image" />
        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            ...
            <div class="social-follow">
              <div class="social-follow" style="margin-right: 140px" style="margin-bottom: 50px;">
                <div class="social-follow" style="margin-bottom: 100px" style="margin-bottom: 10px;">
                </div>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="all-yatras.php">Yatra_Special</a></li>
