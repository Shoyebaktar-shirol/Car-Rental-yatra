    ...
    <ul class="ts-sidebar-menu">
        ...
        <!-- New field for Yatra with dropdown -->
        <li><a href="dashboard.php"><i class="fa fa-map-marker"></i> Yatra</a>
            <ul>
                <li><a href="view-yatra.php">View Yatra</a></li>
                <li><a href="add-yatra.php">Add Yatra</a></li>
              
            </ul>
        </li>

        
			<li><a href="#"><i class="fa fa-sitemap"></i>Yatra Bookings</a>
				<ul>
					<li><a href="new-yatrabookings.php">New</a></li>
					<li><a href="confirmed-yatrabookings.php">Confirmed</a></li>
					<li><a href="cancelled-yatrabookings.php">Cancelled</a></li>
				</ul>
			</li>
