											...
											<div class="panel panel-default">
												<div class="panel-body bk-warning text-light">
													<div class="stat-panel text-center">
														...
														<?php
														$sql7 = "SELECT yatra_id from tbl_yatra ";
														$query7 = $dbh->prepare($sql7);
														$query7->execute();
														$results7 = $query7->fetchAll(PDO::FETCH_OBJ);
														$yatra_id = $query7->rowCount();
														?>

														<div class="stat-panel-number h1 ">
															<?php echo htmlentities($yatra_id); ?></div>
														<div class="stat-panel-title text-uppercase">Yatra_Special</div>
													</div>
												</div>
												<a href="view-yatra.php" class="block-anchor panel-footer text-center">Full
													Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														<?php
														$sql7 = "SELECT id from tblyatrabooking ";
														$query2 = $dbh->prepare($sql7);
														$query2->execute();
														$results2 = $query2->fetchAll(PDO::FETCH_OBJ);
														$bookings = $query2->rowCount();
														?>
														...
														<div class="stat-panel-number h1 ">
															<?php echo htmlentities($bookings); ?></div>
														<div class="stat-panel-title text-uppercase">Total Yatra Bookings
														</div>
													</div>
												</div>
												<a href="manageyatra-bookings.php"
													class="block-anchor panel-footer text-center">Full Detail &nbsp; <i
														class="fa fa-arrow-right"></i></a>
											</div>
										</div>
