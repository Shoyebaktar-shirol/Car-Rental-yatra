													...
													foreach ($results as $result) { ?>
														...
														<tr>
															...
															<td><?php echo htmlentities($result->ContactNo); ?> &nbsp; &nbsp;
																<a href="https://wa.me/9175215526"> <img src="./img/wp.png" alt=""
																		class="wpbutton"></a>
																&nbsp; &nbsp; <a href="tel:+919175212256"> <img src="./img/call.png"
																		alt="" class="wpbutton"> </a>
															</td>
														</tr>
														<tr>
															<th>Address</th>
														...
														<tr>
															...
															<td><?php echo htmlentities($tdays * $ppkm); ?></td>
														</tr>
														<tr>
