            ...
            <div class="contact_form gray-bg">
              <form method="post">
                <div class="form-group">
                  ...
                  <input type="text" name="fullname" placeholder="Enter Name" class="form-control white_bg"
                    id="fullname" required>
                </div>
                <div class="form-group">
                  <label class="control-label">Email Address <span>*</span></label>
                  <input type="email" name="email" placeholder="Ex - abc@gmail.com" class="form-control white_bg"
                    id="emailaddress" required>
                </div>
                <div class="form-group">
                  <label class="control-label">Phone Number <span>*</span></label>
                  <input type="text" name="contactno" placeholder="Phone Number" class="form-control white_bg"
                    id="phonenumber" required maxlength="10" pattern="[0-9]+">
                </div>
                <div class="form-group">
                  <label class="control-label">Message <span>*</span></label>
                  <textarea class="form-control white_bg" placeholder="Type Your Messege Hare" name="message" rows="4"
                    required></textarea>
                </div>
                <div class="form-group">
